...
class WavToWemConverter(QtCore.QObject):
    ...
    def ensure_project_exists(self):
        ...
        cmd = [
            wwisecli_path, wproj_path, "-CreateNewProject",
        ...
        if os.path.isdir(project_dir):
            if os.listdir(project_dir):
                raise Exception(
                    f"Project folder exists but contains no {project_name}.wproj and is not empty: {project_dir}"
                )
